...
public class step2Pane extends stepPane {        
    ...
    static class MyRenderer extends DefaultTreeCellRenderer {
        ...
        public MyRenderer() {
            componentIcon = new ImageIcon(new ImageIcon(ClassLoader.getSystemResource("resources/images/Context.png")).getImage().getScaledInstance(ICON_WIDTH, ICON_HEIGHT, Image.SCALE_SMOOTH));
            contextIcon = new ImageIcon(new ImageIcon(ClassLoader.getSystemResource("resources/images/ContextComponent.png")).getImage().getScaledInstance(ICON_WIDTH, ICON_HEIGHT, Image.SCALE_SMOOTH));            
