...
public class step3Pane extends stepPane{
    ...
    public JPanel build() {        
        ...
        panel.add(new JLabel(java.util.ResourceBundle.getBundle("resources/Bundle").getString("step2_desc")), BorderLayout.NORTH);               
    ...
    public String init(){
        ...
        step3ParameterPanel.add(new JLabel(java.util.ResourceBundle.getBundle("resources/Bundle").getString("parameter")),c);
        c.gridx = 1;    c.gridy = 0;        
        step3ParameterPanel.add(new JLabel(java.util.ResourceBundle.getBundle("resources/Bundle").getString("component")),c);
        c.gridx = 2;    c.gridy = 0;
        step3ParameterPanel.add(new JLabel(java.util.ResourceBundle.getBundle("resources/Bundle").getString("lower_bound")),c);
        c.gridx = 3;    c.gridy = 0;
        step3ParameterPanel.add(new JLabel(java.util.ResourceBundle.getBundle("resources/Bundle").getString("upper_bound")),c);        
    ...
    public String finish(){
        for (int i=0;i<this.lowBound.length;i++){
           try{
               ...
               return java.util.ResourceBundle.getBundle("resources/Bundle").getString("illegal_number_format_of_lower_bound_in_row") + (i+1) + " " + e.toString();
           }
           try{
                this.selectedParameters.get(i).upperBound = Double.parseDouble(this.upBound[i].getText());
           }catch(Exception e){
               return java.util.ResourceBundle.getBundle("resources/Bundle").getString("illegal_number_format_of_upper_bound_in_row") + (i+1) + " " + e.toString();
           }
           if (this.selectedParameters.get(i).lowerBound >= this.selectedParameters.get(i).upperBound){
               return java.util.ResourceBundle.getBundle("resources/Bundle").getString("lower_bound_have_to_be_smaller_than_upper_bound");
           }               
        }
        return null;
    }
