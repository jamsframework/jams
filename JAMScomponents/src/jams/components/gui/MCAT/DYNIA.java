...
public class DYNIA {
    ...
    public DYNIA(SimulationTimeSeriesDataSet timeserie, ParameterSet param, ObservationDataSet observation) {
        ...
        plot.setDomainAxis(new NumberAxis(timeserie_param.name));
        plot.setRangeAxis(new NumberAxis(observation.name));
    ...
    public void updateData() {        
        ...
        for(int i = 0; i < ts_length; i++) {
            dataset.add(i,((observation.set[i]-obs_min)/(obs_max-obs_min))*(maxParam-minParam));
        }        
