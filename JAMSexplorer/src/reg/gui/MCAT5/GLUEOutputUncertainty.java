...
public class GLUEOutputUncertainty {   
    ...
    public GLUEOutputUncertainty(SimulationTimeSeriesDataSet output,ObservationDataSet observation) {
        ...
        plot2.setDomainAxis(new NumberAxis("output"));
        plot2.setRangeAxis(new NumberAxis("time"));

        JFreeChart chart1 = new JFreeChart(plot1);
        JFreeChart chart2 = new JFreeChart(plot2);
        chart1.setTitle("Output uncertainty Plot");
        chart2.setTitle("");                
        chart2.removeLegend();
    ...
    public void updateData() {
        XYSeries dataset1 = new XYSeries("lower confidence bound");
        XYSeries dataset2 = new XYSeries("upper confidence bound");
        XYSeries dataset3 = new XYSeries(this.observation.name);
        XYSeries dataset4 = new XYSeries("no description");
        XYSeries dataset5 = new XYSeries("no description");
