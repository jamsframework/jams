...
/**
 *
 * @author Annika Kuenne <annika.kuenne at uni-jena.de>
 */
@JAMSComponentDescription(
        title = "DoubleArrayMultiply",
        author = "Annika Kuenne",
        description = "Divide double array with one or many double values and return the result",
        date = "2024-03-07",
        version = "1.0_0"
)
...
public class DoubleArrayDivide extends JAMSComponent {
