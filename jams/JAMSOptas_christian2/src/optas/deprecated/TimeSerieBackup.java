...
import optas.data.DefaultDataSet;
 ...
 * @author chris
 */
/*public class TimeSerieBackup extends DefaultDataSet{
    private float set[];
    ...
    public TimeSerieBackup(TimeSerieBackup set){
        this.set = set.set;
    ...
    public TimeSerieBackup(double []value, TimeInterval range, String name, DataSet parent) throws MismatchException{
    ...
    public TimeSerieBackup(double []value, int range, String name, DataSet parent) throws MismatchException{
        set = new float[value.length];
        this.name = name;
        for (int i=0;i<value.length;i++)
            this.set[i] = (float)value[i];
    ...
    public static TimeSerieBackup createFromJ2KTSDataStore(J2KTSDataStore store, int index, String name){
        TimeInterval range = DefaultDataFactory.getDataFactory().createTimeInterval();
        ...
        try{
            return new TimeSerieBackup(value,range, name, null);
    ...
    public static TimeSerieBackup createFromJ2KTSDataStore(J2KTSDataStore store, String selectedAttribute, String name){
