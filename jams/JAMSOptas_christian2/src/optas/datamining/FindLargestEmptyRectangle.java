...
public class FindLargestEmptyRectangle{
    ...
    static public void main(String[] args){
        ...
        DefaultDataCollection dc = DefaultDataCollection.createFromFile(new File("C:/Arbeit/ModelData/Testgebiete/J2000/Gehlberg/output/20120331_013625/complete2.cdat"));
        Set<String> parameterSets = dc.getDataSetNames(Parameter.class);
        ArrayList<DefaultSimpleEnsemble> ps = new ArrayList<DefaultSimpleEnsemble>();
        for (String parameterSet : parameterSets){
            ps.add((DefaultSimpleEnsemble)dc.getDataSet(parameterSet));
        }
        DefaultSimpleEnsemble objective = (DefaultSimpleEnsemble)dc.getDataSet("bias_normalized");
