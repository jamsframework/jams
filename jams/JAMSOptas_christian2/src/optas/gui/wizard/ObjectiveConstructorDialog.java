...
import optas.data.ensemble.DefaultEfficiencyEnsemble.Method;
...
public class ObjectiveConstructorDialog extends JDialog{
    ...
    DefaultEfficiencyEnsemble result = null;
    ...
    private MeasuredTimeSerie getSelectedMeasurement() {
        Object o = ObjectiveConstructorDialog.this.msDataBox.getSelectedItem();
        if (o == null) {
            return null;
        }
        
        MeasuredTimeSerie m = (MeasuredTimeSerie) dc.getDataSet(o.toString());
        return m;
    }
    ...
    private void init(){
        ...
        for (Method m : DefaultEfficiencyEnsemble.Method.values())
        ...
        Set<String> tsDataSets = dc.getDataSetNames(TimeSerie.class);
        ...
        Set<String> msDataSets = dc.getDataSetNames(MeasuredTimeSerie.class);
        ...
        exportTimeFilterButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                    ...
                    if (approved == jfc.APPROVE_OPTION) {
                        result = new DefaultEfficiencyEnsemble("blubb",
                        (MeasuredTimeSerie)dc.getDataSet((String)msDataBox.getSelectedItem()),
                        (DefaultTimeSerieEnsemble)dc.getDataSet((String)simDataBox.getSelectedItem()),
                        (Method)methodList.getSelectedItem(), filterList.getTimeFilters().combine());
                        result.exportTimeFilter(jfc.getSelectedFile(), ObjectiveConstructorDialog.this.chart.hydrograph.getTemporalDomain());
                    }
            }
        });
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                result = new DefaultEfficiencyEnsemble(strName, 
                        (MeasuredTimeSerie)dc.getDataSet((String)msDataBox.getSelectedItem()),
                        (DefaultTimeSerieEnsemble)dc.getDataSet((String)simDataBox.getSelectedItem()),
                        (Method)methodList.getSelectedItem(), filterList.getTimeFilters().combine());
                isApproved = true;
    ...
    public DefaultEfficiencyEnsemble getResult(){
        return result;
    }
}
