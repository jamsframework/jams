...
public class ResponseSurface extends MCAT5Plot {
    ...
    private JComponent createAdjustmentPanel(SimpleEnsemble p[], DefaultEfficiencyEnsemble e){
        ...
        for (int i=0;i<p.length;i++){
            ...
            sliderGroup.setBorder(BorderFactory.createTitledBorder(p[i].getName()));
            ...
            slider.addChangeListener(new ChangeListener() {
                ...
                public void stateChanged(ChangeEvent evt) {
                    ...
                    double paramMin = ((DefaultSimpleEnsemble)(slider.getClientProperty("paramter"))).getMin();
                    double paramMax = ((DefaultSimpleEnsemble)(slider.getClientProperty("paramter"))).getMax();
        ...
        parameter1Box.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                ...
                DefaultSimpleEnsemble p = (DefaultSimpleEnsemble)src.getSelectedItem();
                paramMin1 = p.getMin();
                paramMax1 = p.getMax();
    ...
    public void refresh() throws NoDataException{
        ...
        if (dc == null) {
            ...
            ArrayList<DataSet> p[] = getData(new int[]{0});
            y = (DefaultEfficiencyEnsemble) p[1].get(0);
