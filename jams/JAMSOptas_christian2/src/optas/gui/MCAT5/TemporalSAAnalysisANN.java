...
public class TemporalSAAnalysisANN extends MCAT5Plot {
    ...
    DefaultEfficiencyEnsemble e = null;
        ...
        groupConfigurator.addUpdateListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (e.getActionCommand().equals("update")){
                    ...
                    int Ttotal = TemporalSAAnalysisANN.this.ts.getNumberOfTimesteps();
                    ...
                    for (int j = 0; j < k; j++) {
                        ...
                        DefaultTimeFilter f = TimeFilterFactory.getSelectiveTimeFilter(dates);
        ...
        weightChartPanel.addChartMouseListener(new ChartMouseListener() {
            ...
            public void chartMouseClicked(ChartMouseEvent event) {
                ...
                if (e != null && e instanceof XYItemEntity) {
                    ...
                    DataCollection dc = DataCollection.getInstance("New Collection");
                    dc.addDataSet(new DefaultEfficiencyEnsemble(ts.get(data),false));
                    for (int i = 0; i < p.length; i++) {
                        dc.addDataSet(p[i]);
                    }
                    try {
    ...
    public void refresh() throws NoDataException {
        ...
        ts = (DefaultTimeSerieEnsemble) data[0].get(0);
        obs = (MeasuredTimeSerie) data[1].get(0);
        e = (DefaultEfficiencyEnsemble) data[2].get(0);

        Set<String> xSet = this.getDataSource().getDataSetNames(Parameter.class);
        p = new DefaultSimpleEnsemble[xSet.size()];
        int counter = 0;
