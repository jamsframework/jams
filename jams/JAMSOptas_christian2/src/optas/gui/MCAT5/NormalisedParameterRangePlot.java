...
public class NormalisedParameterRangePlot extends MCAT5Plot{
    ...
    double[][] getMinMaxParetoTS(DefaultSimpleEnsemble[]data, DefaultEfficiencyEnsemble eff[]){
    ...
    public void refresh() throws NoDataException {
        ...
        DefaultSimpleEnsemble[] params = new DefaultSimpleEnsemble[dataInParam.size()];
        ...
        for (int i=0;i<dataInParam.size();i++)
            params[i] = (DefaultSimpleEnsemble)dataInParam.get(i);
