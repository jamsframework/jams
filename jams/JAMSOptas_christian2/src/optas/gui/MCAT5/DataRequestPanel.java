...
public final class DataRequestPanel extends JPanel {
    ...
    public final class RequestGUI {
        ...
        public boolean addBox() {
            ...
            if (data.getDataSetNames(request.clazz).isEmpty() && request.min > 0) {
                return false;
            }

            for (String d : data.getDataSetNames(request.clazz)) {
                box.addItem(d);
            }
            ...
            box.addItemListener(new ItemListener() {
                public void itemStateChanged(ItemEvent e) {
                    ...
                    if (e.getItem().toString().compareTo("User defined") == 0) {
                        ...
                        dlg.setVisible(true);
                        if (dlg.getApproved()) {
                            DefaultEfficiencyEnsemble ensemble = dlg.getResult();
                            JComboBox box = (JComboBox) e.getSource();
                            DataRequestPanel.this.data.addDataSet(ensemble);
