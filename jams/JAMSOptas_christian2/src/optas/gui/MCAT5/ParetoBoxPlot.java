...
public class ParetoBoxPlot extends MCAT5Plot {
    ...
    class ObjectiveTableModel extends AbstractTableModel {
        ...
        DefaultEfficiencyEnsemble objectives[] = null;
        ...
        ObjectiveTableModel(DataCollection dataSource) {
            ...
            Set<String> effDataSets = this.dataSource.getDataSetNames(Efficiency.class);
            m = effDataSets.size();
            ...
            objectives = new DefaultEfficiencyEnsemble[m];
            for (int i=0;i<m;i++){
                objectives[i] = (DefaultEfficiencyEnsemble)dataSource.getDataSet(name[i]);
            }
        }
    ...
    private void initDataSet() {
        ...
        Set<String> parameterSet = this.getDataSource().getDataSetNames(Parameter.class);
    ...
    public void updateBoxPlot(ArrayList<Sample> candidates) {
        ...
        for (List<Double> parameter : parameterValues) {
            dataset.add(parameter, "Single Series1", parameterEnsembles[parameterNumber].getName());            
    ...
    public static void main(String[] args) {
        DefaultDataCollection dc = DefaultDataCollection.createFromFile(new File("E:\\ModelData\\Testgebiete\\J2000\\Gehlberg\\output\\20140424_131138\\new_nsga_sample.cdat"));
