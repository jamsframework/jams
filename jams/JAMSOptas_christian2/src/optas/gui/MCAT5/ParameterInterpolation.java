...
public class ParameterInterpolation extends MCAT5Plot {
    ...
    DefaultTimeSerieEnsemble timeserie;
    DefaultSimpleEnsemble[] params;
    ...
    public void refresh() throws NoDataException{
        ...
        timeserie = (DefaultTimeSerieEnsemble)p[0].get(0);
        ArrayList<DataSet>  dataInParam   = (ArrayList<DataSet>)p[1];
        MeasuredTimeSerie obs = (MeasuredTimeSerie) p[2].get(0);

        params = new DefaultSimpleEnsemble[dataInParam.size()];
        int timesteps = timeserie.getNumberOfTimesteps();
    ...
    public void doInterpolation(int parameter) {
        ...
        for (int r = 0; r < RESOLUTION; r++) {
            ...
            for (int t = 0; t < this.timeserie.getNumberOfTimesteps();t++){
