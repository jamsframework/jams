...
public abstract class MCAT5Plot extends Observable{
    ...
    public class Result{
        ...
        public Result(){
            ...
            data.add(new DefaultDataSet("dataset"));
            valid = false;
        }
    ...
    public ArrayList<DataSet>[] compile(int[] list) throws NoDataException{
        ...
        for (int i=0;i<list.length;i++){
            ...
            for (DataSet d : r.data){
                ...
                if (d instanceof DefaultEnsemble){
                    DefaultEnsemble ensemble = (DefaultEnsemble)d;
        ...
        for (int i=0;i<list.length;i++){
            ...
            for (DataSet d : r.data){
                if (d instanceof DefaultEnsemble){
                    DefaultEnsemble ensemble = ((DefaultEnsemble)d).clone();
