...
public class ParameterInterpolation2 extends MCAT5Plot {
    ...
    public void updatePlot(){
        ...
        for (int i=0;i<n;i++){
            if (this.params[i].getName().equals(this.param1.name))
                index1 = i;
            if (this.params[i].getName().equals(this.param2.getName()))
                index2 = i;
        }
    ...
    public void refresh() throws NoDataException{
        ...
        param1 = (DefaultSimpleEnsemble)p[0].get(0);
        param2 = (DefaultSimpleEnsemble)p[1].get(0);
        ...
        y = (DefaultEfficiencyEnsemble)p[2].get(0);
