...
public class GLUEOutputUncertainty extends MCAT5Plot {
    ...
    DefaultEfficiencyEnsemble eff = null;
    ...
    public void refresh() throws NoDataException {
        ...
        DefaultEfficiencyEnsemble eff = (DefaultEfficiencyEnsemble) p[1].get(0);
        ...
        if (obs != null) {
            ...
            for (int i = 0; i < obs.getNumberOfTimesteps(); i++) {
        ...
        if (showAll) {
            ...
            for (int i = 0; i < ts.getSize(); i++) {
                ...
                int id = ts.getId(i);
                for (int j = 0; j < ts.getNumberOfTimesteps(); j++) {
        ...
        double low_conf[] = new double[ts.getNumberOfTimesteps()];
        double high_conf[] = new double[ts.getNumberOfTimesteps()];
