...
public class SlopeCalculations {
    ...
    static private XYSeries[] calcRegression(SimpleEnsemble param[], DefaultEfficiencyEnsemble eff) {
        int N = eff.getSize();
        int n = param.length;
        int k = 2 * n;
        int iter = N / (k+1);
    ...
    static public XYSeries[] calculateDerivative(DefaultEfficiencyEnsemble eff, DataCollection dc) {
    ...
    static public XYSeries[] calculateGradientAtTime(DataCollection param, DefaultTimeSerieEnsemble timeseries, int timeIndex) {
    ...
    static public XYSeries[] calculateDerivativesAtTime(SimpleEnsemble param[], DefaultTimeSerieEnsemble timeseries, int timeIndex, double range_min[], double range_max[]) {
        /*XYSeries dataset = new XYSeries(JAMS.i18n("DATA_POINT"));
...
/*
    ...
    static public SimpleEnsemble[] getParameterEnsembles(DataCollection d) {
        Set<String> parameterSets = d.getDataSetNames(Parameter.class);
    ...
    static public double[][] calculateBehavourialRange(DefaultSimpleEnsemble parameter[], DefaultSimpleEnsemble objective, double threshold){
    ...
    static public double[][] calcParameterSensitivityTimeserie(DefaultDataCollection d, DefaultTimeSerieEnsemble timeserie, TimeSerie<Double> obs, double threshold) {
        SimpleEnsemble p[] = getParameterEnsembles(d);
        int n = p.length;
        int T = timeserie.getNumberOfTimesteps();

        double result[][] = new double[n][timeserie.getNumberOfTimesteps()];
