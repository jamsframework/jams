...
public class HydrographEvent implements Comparable {
    ...
    private static HydrographEvent isEvent(int evtStart, int evtEnd, TimeSerie<Double> hydrograph){
    ...
    public static ArrayList<HydrographEvent> findEvents(TimeSerie<Double> hydrograph, int windowSize) {
