...
public class Statistics implements Serializable{
    ...
    public double calcQuality(){
        ...
        DefaultSimpleEnsemble ensemble[] = new DefaultSimpleEnsemble[this.n()];
        ...
        for (int i = 0; i < m; i++) {
            ...
            DefaultSimpleEnsemble y[] = new DefaultSimpleEnsemble[m];
            ...
            y[i] = new DefaultEfficiencyEnsemble("test", L, false, rmin, rmax); //TODO .. die grenzen sind obj. abhängig ..

            for (int k = 0; k < n(); k++) {
                ensemble[k] = new DefaultSimpleEnsemble("test", L);
            }
            int counter = 0;
            for (int j = 0; j < L; j++) {
