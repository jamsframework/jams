...
public class Calculations {
    ...
    static public double[] calcBounds(ArrayList<Sample> list, int param, int objective, int boxcount, double threshold){
        DefaultSimpleEnsemble p = new DefaultSimpleEnsemble("test1", list.size());
        DefaultEfficiencyEnsemble e = new DefaultEfficiencyEnsemble("test2", list.size(), false);
    ...
    static public double[] calcBounds(DefaultSimpleEnsemble p, DefaultEfficiencyEnsemble e, int boxcount, double threshold){
...
/*        double pmax = p.getValue(p.findArgMax());
    ...
    static public double[] calcPostioriDistribution(DefaultSimpleEnsemble p, DefaultEfficiencyEnsemble e, int boxcount){
