...
public class UniversalEfficiencyCalculatorSerialized extends JAMSComponent{
    ...
    public void run(){
        for (int i = 0; i < m; i++) {
            ...
            measurementList[i] = ((ArrayList) measurement[i].getValue());
            simulationList[i] = ((ArrayList) simulation[i].getValue());
