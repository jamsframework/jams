 ...
 */
public class UniversalEfficiencyCalculator2 extends JAMSComponent{
    ...
    static final public int RMSE = 0, NSE1=1,NSE2=2,LNSE1=3,LNSE2=4,AVE=5,R2=6,RBIAS=7,KGE=8,KGEN=9;
