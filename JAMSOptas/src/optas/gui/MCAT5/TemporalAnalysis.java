...
import optas.hydro.TemporalSensitivityAnalysis;
...
public class TemporalAnalysis extends MCAT5Plot {
    ...
    private void init() {
        ...
        sideLayout.setHorizontalGroup(sideLayout.createParallelGroup().addComponent(parameterTablePane).addComponent(infoLabel).addComponent(calcScheme).addComponent(optimizationSchemes).addComponent(parameterGroups).addComponent(exportScheme));
