...
public class ParallelSCE extends Optimizer {

    static public class InputData implements Serializable {
        public ParallelSCE context;
        ...
        public InputData(ParallelSCE context, int nspl, int nps, int npg, int nopt, SampleSO[] c, SampleSO[] x, int[] k1, int[] k2, double[] bu, double[] bl) {
        ...
        while (criter_change > pcento) {
            ...
            for (int igs = 0; igs < ngs; igs++) {
                ...
                ParamRunnable r = new ParamRunnable<InputData>(param) {
                    ...
                    @Override
                    public void run() {
                        synchronized(ParallelSCE.this){ //really strict. something less strict would be better .. 
    ...
    public OptimizerDescription getDescription() {
        OptimizerDescription desc = OptimizerLibrary.getDefaultOptimizerDescription(ParallelSCE.class.getSimpleName(), ParallelSCE.class.getName(), 6, false);
