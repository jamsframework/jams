...
public class ParallelPostSampling extends Optimizer{    
    ...
    public void procedure() throws SampleLimitException, ObjectiveAchievedException {
        ...
        ParallelExecution<EstimateBoundsInputData, EstimateBoundsOutputData> executor = new ParallelExecution<EstimateBoundsInputData, EstimateBoundsOutputData>(workspace, excludeFiles);
