...
public class Protocol {
    ...
    public static final int MANAGEMENT_RUN_MODEL = 20;
    public static final int CONFIGURE_MODEL = 21;
    public static final int GET_JOBLIST = 22;
    public static final int GET_FILELIST = 23;
