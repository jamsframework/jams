...
import jams.components.gui.MCAT.MCAT5.SimulationDataSet;
...
public class GLUEVariableUncertainty {   
    ...
    public GLUEVariableUncertainty(SimulationDataSet var, EfficiencyDataSet eff) {
        ...
        plot2.setRenderer(new XYBarRenderer(0.2));                                
    ...
    public void updateData() {                        
        ...
        plot1.setDataset(0, new XYBarDataset(new XYSeriesCollection(dataset1), 0.5));
        plot1.setDataset(1, new XYBarDataset(new XYSeriesCollection(dataset3), 0.5));
        plot2.setDataset(0, new XYBarDataset(new XYSeriesCollection(dataset2), 0.5));
