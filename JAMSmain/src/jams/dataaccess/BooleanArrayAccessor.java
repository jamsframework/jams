...
public class BooleanArrayAccessor implements DataAccessor {
    ...
    public BooleanArrayAccessor(DataFactory dataFactory, Attribute.Entity[] entities, JAMSData dataObject, String attributeName, int accessType, int updateType) throws JAMSEntity.NoSuchAttributeException {
