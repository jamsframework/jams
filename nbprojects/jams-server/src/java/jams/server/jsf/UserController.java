package jams.server.jsf;

import jams.server.entities.User;
import jams.server.jsf.util.JsfUtil;
import jams.server.jsf.util.PaginationHelper;
import jams.server.session.UserFacade;
...
public class UserController implements Serializable {
    ...
    @EJB private jams.server.session.UserFacade ejbFacade;
