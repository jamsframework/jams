...
public class UserController extends Controller{    
    ...
    public Users getAllUsers() throws JAMSClientException{
        return (Users) client.httpGet(serverURL + "/user/all", Users.class);
    }

    public Users getUsersInRange(int from, int to) throws JAMSClientException{
        return (Users)client.httpGet(serverURL + "/user/" + from + "/" + to, Users.class);
    }

    public User getUser(int id) throws JAMSClientException{
        return (User) client.httpGet(serverURL + "/user/" + id, User.class);
    }

    public User removeUser(int id) throws JAMSClientException{
        return (User)client.httpPost(serverURL + "/user/" + id, "DELETE", null, User.class);
    }

    public User createUser(User user) throws JAMSClientException{
