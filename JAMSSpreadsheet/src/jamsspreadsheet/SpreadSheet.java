...
import jams.components.gui.spreadsheet.*;
...
//            public JAMSDouble[] rowarray;
    ...
    /* Constructor */
    public SpreadSheet(JFrame parent) {
        this.parent = parent;
    }
    ...
    private void initOpen(){
        ...
        try{
            ...
            File file = new File("F:/datensatz.dat");
    ...
    ActionListener openAction = new ActionListener(){
         public void actionPerformed(ActionEvent e) {
             ...
             int result = LHelper.showYesNoCancelDlg(parent, "Do you want to save this sheet before?", "Attention");
...
*/             
    ...
    private void openCTS(){
        ...
        //if(!ctsIsOpen){
        JTSConfigurator jts = new JTSConfigurator(parent, this.table);
    ...
    private void openCXYS(){
        ...
        JXYConfigurator jxys = new JXYConfigurator(parent, this.table);
