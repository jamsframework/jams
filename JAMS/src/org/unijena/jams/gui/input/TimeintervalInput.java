...
public class TimeintervalInput extends JPanel implements InputComponent {
    ...
    private static final long serialVersionUID = 4267278765142872815L;
    ...
    public TimeintervalInput() {
        ...
        LHelper.addGBComponent(this, gbl, new JLabel("Time Unit: "), 0, 3, 1, 1, 0, 0);
        LHelper.addGBComponent(this, gbl, new JLabel("Time Unit Count: "), 0, 4, 1, 1, 0, 0);
        
        syear = new JTextField();
        syear.setInputVerifier(new NumericIntervalVerifier(1900, 2100));
        syear.setPreferredSize(new Dimension(50, 26));
        
        smonth = new JTextField();
        smonth.setInputVerifier(new NumericIntervalVerifier(1, 12));
        smonth.setPreferredSize(new Dimension(35, 26));
        
        sday = new JTextField();
        sday.setInputVerifier(new NumericIntervalVerifier(1, 31));
        sday.setPreferredSize(new Dimension(35, 26));
        ...
        shour.setPreferredSize(new Dimension(35, 26));
        
        sminute = new JTextField();
        sminute.setInputVerifier(new NumericIntervalVerifier(0, 59));
        sminute.setPreferredSize(new Dimension(35, 26));
        ...
        ehour.setPreferredSize(new Dimension(35, 26));
        
        eminute = new JTextField();
        eminute.setInputVerifier(new NumericIntervalVerifier(0, 59));
        eminute.setPreferredSize(new Dimension(35, 26));
        ...
        timeUnit.setPreferredSize(new Dimension(40, 26));
        ...
        tuCount.setPreferredSize(new Dimension(40, 26));
