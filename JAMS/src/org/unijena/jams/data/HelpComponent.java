...
public class HelpComponent {
    ...
    public static ImageIcon HELP_ICON = new ImageIcon(new ImageIcon(ClassLoader.getSystemResource("resources/images/help.png")).getImage().getScaledInstance(12, 12, Image.SCALE_SMOOTH));
