 ...
 * @author S. Kralisch
 */
public class TimeintervalInput2 extends JPanel implements InputComponent {
    ...
    private CalendarInput2 startDate, endDate;

    private Color oldColor;

    public TimeintervalInput2() {
        this(false);
    }

    public TimeintervalInput2(boolean intervalEdit) {
...
//        GUIHelper.addGBComponent(this, gbl, new JLabel(JAMS.resources.getString("Time_(HH:MM)")), 11, 0, 1, 1, 0, 0);
        ...
        startDate = new CalendarInput2(false);
        ...
        endDate = new CalendarInput2(false);
...
//        GUIHelper.addGBComponent(this, gbl, test, 1, 6, 1, 1, 0, 0);
    ...
    public void addValueChangeListener(ValueChangeListener l) {
        ...
        this.timeUnit.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                TimeintervalInput2.this.l.valueChanged();
            }
        });
    ...
    public static void main(String[] args) {
        InputComponent tii = new TimeintervalInput2(true);
