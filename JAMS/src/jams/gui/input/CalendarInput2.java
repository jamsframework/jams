 ...
 * @author S. Kralisch
 */
public class CalendarInput2 extends JPanel implements InputComponent {
    ...
    public CalendarInput2() {
        this(true);
    }

    public CalendarInput2(boolean doLayout) {
...
//            GUIHelper.addGBComponent(this, gbl, test, 1, 2, 1, 1, 0, 0);
    ...
    public void addValueChangeListener(ValueChangeListener l) {
        ...
        this.dateText.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                CalendarInput2.this.l.valueChanged();
            }
    ...
    public static void main(String[] args) {
        InputComponent tii = new CalendarInput2();
