    ...
    public static void Documentation_Complete(String directory,String model,String pathin_vorlage,ArrayList<ArrayList<String[]>> component) {
                    ...
                    for (i=0;i<c.length;i++)
                       {
                        ...
                        if (c[i]=='"' && azahl==0) {startc=i;azahl++;i++;}
                        if (c[i]=='"' && azahl==1) {endc=i;azahl++;i++;}
                        if (c[i]=='"' && azahl==2) {startn=i;azahl++;i++;}
                        if (c[i]=='"' && azahl==3) {endn=i;azahl++;i++;}
                     ...
                     if (line.contains("<contextcomponent")) {ContextComponent.add(0,Name);}
                   ...
                   { 
                     //  line1=line3.substring(16);
                       ...
                       while (c[i]!=('"'))
                       {
                            ...
                            if (c[i]!=(' ')) {line4=line4+Character.toString(c[i]);}
                            i++;
                        c = line1.toCharArray();
     ...
     public static void Doku_AnnotitionAndManuell( BufferedWriter bibliography,ArrayList<String> BiblioEntryList,String pathin_vorlage,String pathin_annotation,String pathin_docu,String pathout,String pathout1,ArrayList<ArrayList<String[]>> component) {
      ...
      try
      {
                    ...
                    for (i=0;i<50;i++)
                    {
                        ...
                        {              
                            ...
                            */
                            ...
                            if (variablen[i][6].equals("%NULL%")) {variablen[i][6]="n/a";}
            ...
            for (int i=0;i<variablencount;i++)
            {
                if (variablen[i][5].equals("READ")) {eingangs=true;}
            }         
            if (eingangs==true)
            {
        ...
        "<tgroup cols=\"4\">\n"+
            ...
            for (int i=0;i<variablencount;i++)
            {
                ...
                if (start!=0) {variablen[i][4]=variablen[i][4].substring(start+1, c.length);}
            ...
            for (int i=0;i<variablencount;i++)
            {
                if (variablen[i][5].equals("READWRITE")) {status=true;}
            }         
            if (status==true)
            {
            ...
            for (int i=0;i<variablencount;i++)
            {
                if (variablen[i][5].equals("WRITE")) {ausgangs=true;}
            }         
            if (ausgangs==true)
            {
