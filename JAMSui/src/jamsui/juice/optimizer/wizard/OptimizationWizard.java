...
public class OptimizationWizard {
    ...
    public HashMap<String, String> createOptimizationIni() {
        ...
        for (Object obj : objects) {
            ...
            switch(modeIndex.intValue()){
                case 0: mode = new Integer(1); break;
                case 1: mode = new Integer(2); break;
                case 2: mode = new Integer(4); break;
                case 3: mode = new Integer(3); break;
                default:mode = new Integer(1); break;
            }            
    ...
    public static void main(String arg[]) {
        ...
        if (arg[0].compareTo("analyze") == 0) {
            ...
            File modelFile = new File(arg[1]);
            File propertyFile = new File(arg[2]);
            File optimizationIniFile = new File(arg[3]);
            File workspace = new File(arg[4]);
            System.setProperty("user.dir", workspace.getAbsolutePath());
            try {
                modelModifier.modelModifier(propertyFile, modelFile, optimizationIniFile);
            } catch (WizardException e) {
